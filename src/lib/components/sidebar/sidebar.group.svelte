...
<ul class="space-y-2 {border_class}">
    ...
    {#if inserter}
        <Edit class="p-3 sm:p-2 text-lg sm:text-base font-normal text-stone-500 rounded-lg dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-700" on_enter={inserter} placeholder={inserter_placeholder} inserter={true}>

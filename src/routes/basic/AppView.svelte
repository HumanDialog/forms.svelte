        ...
        return {
                ...
                mainContent : {
                    routes : {
                        ...
                        '/myarchivedlists': {component: TaskLists},
                        '/mydeletedlists': {component: TaskLists},
                        '/listtemplates':{component: TaskLists},
                        '/allprojects': {component: TaskLists},
                        '/archivedprojects': {component: TaskLists},
                        '/deletedprojects': {component: TaskLists},

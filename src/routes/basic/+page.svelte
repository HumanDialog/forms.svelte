<script>
    ...
    const r = /^\/listboard|tdownload|tcontact|tasklist|deslis|design|ask|note|folder|mytasks|mylists|mynotes|alllists|myfolders|group-folders|general-channels|private-channels|members|chat|thread|newthread|forum|thome|profile|doc|request-license-file|nav\/(.*)\/?$/i

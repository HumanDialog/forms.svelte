<script lang="ts">
    ...
    import {cookies_valid_until} from '../landing/cookie.preferences'
    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center text-slate-700 dark:text-slate-200" aria-label="Home page">
        ...
        <div class="flex items-center justify-between">
            <span class="text-xs sm:text-sm text-gray-500 text-center dark:text-gray-400">© 2025 <a href="https://humandialog.com/"
            ...
            <div class="flex space-x-6 justify-center mt-0">
                ...
                <a href="https://github.com/HumanDialog/octopus.basic.svelte" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="github">
                ...
                <button class="w-4 h-5 text-gray-500 hover:text-gray-900 dark:hover:text-white" on:click={setup_cookies} aria-label="cookies"><FaCookieBite/></button>

...
<div>
    ...
    <div class="pb-20 dark:bg-stone-900"> <!--  bg-local bg-cover" style="background-image: url(b-sm1.jpg)-->

        <div class="sm:max-w-5xl mx-3 sm:mx-auto flex flex-col sm:flex-row gap-10
                        pt-10 sm:pt-24 lg:pt-32">

        
            <div class="text-left text-sm text-slate-600  dark:text-slate-400">
                <h1
                    class="text-slate-900 font-extrabold text-3xl sm:text-4xl lg:text-5xl tracking-tight dark:text-white">
                    Contact us</h1>
            ...
            <div class="sm:flex-none sm:w-[480px] flex flex-col gap-3">
                <section class="sm:w-full flex flex-col sm:flex-row gap-3">
                    <input  placeholder="Name" 
                            ...
                            class=" flex-1
                                    ...
                                    border border-gray-300 rounded-lg dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500
                ...
                <p class="text-sm text-slate-600  dark:text-slate-400 text-right">
                ...
                <button class=" block h-10 w-30 ml-auto
                                bg-slate-900 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-white font-semibold px-6 rounded-lg  flex items-center justify-center  dark:bg-indigo-600 dark:highlight-white/20 dark:hover:bg-indigo-400"
                                on:click={submit}
                    ...
                    {:else}
                        <div role="status" class="w-full">
                            <svg aria-hidden="true" class="w-5 h-5  text-slate-800 animate-spin dark:text-indigo-400 fill-gray-200 dark:fill-indigo-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

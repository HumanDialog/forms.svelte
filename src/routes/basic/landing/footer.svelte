...
<footer class="p-4 sm:p-6  mt-auto mb-0 {classes}">
    <div class="mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-xs sm:text-base">
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li class="mb-2 sm:mb-4">
                            <a href="https://github.com/HumanDialog" class="hover:underline ">GitHub</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="flex items-center justify-between">
            <span class="text-xs sm:text-sm text-gray-500 text-center dark:text-gray-400">© 2024 <a href="https://humandialog.com/"
            ...
            <div class="flex space-x-6 justify-center mt-0">
                ...
                <a href="https://github.com/HumanDialog" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label="github">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
